...
<head>
    ...
    <title>{{ setting('site_title', '') }} | Admin | {{ setting('site_title', '') }}</title>
    <!-- plugins:css -->
                ...
                <div class="card-body card-body-padding d-flex align-items-center justify-content-between">
                    <div class="ps-lg-1">
                        <div class="d-flex align-items-center justify-content-between">
                            <p class="mb-0 font-weight-medium me-3 buy-now-text">Chào mừng đến với trang quản trị hệ thống của {{ setting('site_title', '') }}!</p>
                            <a href="tel:0349937818"
                                target="_blank" class="btn me-2 buy-now-btn border-0">Get Go</a>
                        </div>
                    </div>
                    <div class="d-flex align-items-center justify-content-between">
                        <a href="{{route('home')}}"><i
        ...
        <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                ...
                <a class="navbar-brand brand-logo-mini" href="{{route('home')}}"><img
                        src="{{ setting('site_logo', '') }}" alt="logo" /></a>
            </div>
                    ...
                    <li class="nav-item nav-profile dropdown">
                        <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown"
                            ...
                            <div class="nav-profile-img">
                                <img src="{{ Auth::user()->avatar??'/images/avatar/default.jpg' }}" alt="image">
                    ...
                    <li class="nav-item nav-profile">
                        <a href="#" class="nav-link">
                            <div class="nav-profile-image">
                                <img src="{{ Auth::user()->avatar??'/images/avatar/default.jpg' }}" alt="profile">
